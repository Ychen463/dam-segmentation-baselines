...
\begin{itemize}
    \item A topology-aware segmentation framework combining dynamic snake convolution with skeleton-based supervision for fine-grained dam defect segmentation.
